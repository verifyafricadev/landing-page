  ...
  return (
    <section className="py-16 md:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div ref={cardsRef} className="grid grid-cols-1 sm:grid-cols-2 gap-5 md:gap-6">
          {feature.useCases.map((uc, i) => (
            ...
            >
              <div className="w-12 h-12 flex items-center justify-center bg-teal-100 rounded-lg flex-shrink-0">
                <i className={`${getIcon(uc.industry)} text-xl text-teal-600`} />
              </div>
              <div>
                <h3 className="text-base font-bold text-gray-900 mb-1.5">{uc.industry}</h3>

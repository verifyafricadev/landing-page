...
const caseStudiesSchema = [
  ...
  // ── ItemList — industries served ─────────────────────────────────────────
  {
    ...
    description: 'Regulated industries across Africa that use VerifyAfrica for KYC, AML, and identity verification compliance.',
    numberOfItems: 8,
    itemListElement: [
      {
        '@type': 'ListItem',
        ...
        url: `${SITE_URL}/case-studies`,
        description: 'Traditional banks, microfinance institutions, and credit unions requiring robust KYC/AML compliance across Africa.',
      },
      {
        '@type': 'ListItem',
        position: 2,
        ...
        url: `${SITE_URL}/case-studies`,
        description: 'Digital payment platforms, mobile money operators, and fintech startups scaling across Africa with instant user verification.',
      },
      {
        '@type': 'ListItem',
        position: 3,
        name: 'FX Brokers',
        url: `${SITE_URL}/case-studies`,
        description: 'Foreign exchange brokers requiring automated risk-based client tiering, EDD, and cross-border regulatory reporting.',
      },
      {
        '@type': 'ListItem',
        position: 4,
        ...
        url: `${SITE_URL}/case-studies`,
        description: 'Online casinos and sports betting operators meeting AML and responsible gambling compliance across Africa\'s regulated markets.',
      },
      {
        '@type': 'ListItem',
        position: 5,
        ...
        url: `${SITE_URL}/case-studies`,
        description: 'Mobile network operators requiring SIM registration, mobile money compliance, and SIM swap fraud prevention.',
      },
      {
        '@type': 'ListItem',
        position: 6,
        ...
        url: `${SITE_URL}/case-studies`,
        description: 'Online marketplaces verifying buyers and sellers with identity confirmation and payment fraud prevention.',
      },
      {
        '@type': 'ListItem',
        position: 7,
        ...
        url: `${SITE_URL}/case-studies`,
        description: 'Insurance providers requiring policyholder verification and claims fraud prevention across Africa.',
      },
      {
        '@type': 'ListItem',
        position: 8,
        name: 'Crypto & Web3',
        url: `${SITE_URL}/case-studies`,
        description: 'Cryptocurrency exchanges and DeFi platforms meeting FATF travel rule and global compliance standards.',
      },
    ],
  },

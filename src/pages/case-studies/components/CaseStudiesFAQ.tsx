...
const faqs: FAQItem[] = [
  ...
  {
    question: 'What compliance results have clients achieved with VerifyAfrica?',
    answer:
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-teal-50 rounded-full mb-4">
            ...
            <span className="text-teal-600 text-sm font-medium">Frequently Asked Questions</span>
          </div>

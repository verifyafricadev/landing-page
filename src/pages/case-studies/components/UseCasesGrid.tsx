...
export default function UseCasesGrid({ onRequestDemo }: UseCasesGridProps) {
  ...
  const [selectedUseCase, setSelectedUseCase] = useState<typeof useCaseCategories[0] | null>(null);
  ...
  const filteredUseCases = selectedCategory === "All Categories" 
    ? useCaseCategories 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-teal-50 rounded-full mb-4">
            ...
            <span className="text-teal-600 text-sm font-medium">Industry Solutions</span>
          </div>
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
            Who Needs Identity Verification?
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Explore how different industries leverage VerifyAfrica to streamline compliance, prevent fraud, and build trust.
          </p>
        </div>
        ...
        {filteredUseCases.length === 0 && (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-700 mb-2">No use cases found</h3>

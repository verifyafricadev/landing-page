      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        <div className="text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-teal-500/10 border border-teal-500/20 rounded-full mb-6">
            ...
            <span className="text-teal-400 text-sm font-medium">Use Cases &amp; Coverage</span>
          </div>
          ...
          <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto mb-10">
            From banks to fintechs, e-commerce to FX Brokers, discover how different industries 
            use our identity verification platform across 54 African countries.
          </p>

...
export default function SupportForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('https://readdy.ai/api/form/d7phe8vhqnrhtnv4fih0', {
        method: 'POST',
        headers: {
    ...
    <section className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-6 lg:px-12">
        <div className="mb-12 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Submit a Support Request</h2>
          <p className="text-gray-600">Fill out the form below and our team will respond as soon as possible</p>
        </div>

        <form id="support-form" data-readdy-form onSubmit={handleSubmit} className="space-y-6">
          ...
          {status === 'success' && (
            <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
              <p className="text-sm text-green-800">Your support request has been submitted successfully. We'll get back to you within 24 hours.</p>
            </div>
          )}

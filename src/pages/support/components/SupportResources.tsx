    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600">Find answers and resources to help you get started</p>
        </div>

        <div className="grid md:grid-cols-2 gap-6">
          <a href="/support" className="bg-white p-6 rounded-xl border border-gray-100 hover:border-teal-200 hover:bg-teal-50/30 transition-colors cursor-pointer">
          ...
          <a href="/contact" className="bg-white p-6 rounded-xl border border-gray-100 hover:border-teal-200 hover:bg-teal-50/30 transition-colors cursor-pointer">

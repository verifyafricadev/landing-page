...
const docsSchema = [
  {
    ...
    teaches: 'How to integrate KYC, AML, and identity verification for African markets via REST API',
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description: 'Verify national IDs, passports, and driver\'s licences across 54 African countries.',
          },
        },
        {
          '@type': 'Offer',
          itemOffered: {
            ...
            description: 'Facial recognition and liveness detection to prevent spoofing and synthetic identity fraud.',
          },
        },
        {
          '@type': 'Offer',
          itemOffered: {
            ...
            description: 'Real-time screening against global sanctions lists, PEP databases, and adverse media sources.',
          },
        },
        {
          '@type': 'Offer',
          itemOffered: {
            ...
            description: 'Verify business entities, directors, and beneficial owners across African corporate registries.',
          },
        },
      ],
    },
  },
  {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        description: 'Validate residential and business addresses across African markets.',
      },
      {
        '@type': 'ListItem',
        position: 6,
        ...
        description: 'Batch processing endpoints for back-book remediation and mass onboarding programmes.',
      },
    ],
  },
  {
...
export default function DocsPage() {
  ...
  const [selectedVerification, setSelectedVerification] = useState('id_document');
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-gray-900 to-gray-800 pt-28 pb-12">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <h1 className="text-3xl lg:text-4xl font-bold text-white mb-3">API Documentation</h1>
      ...
      <div className="bg-gray-100 border-t border-gray-200 py-6">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center">
          <p className="text-sm text-gray-600">
            ...
            <a href="mailto:dev@verifyafrica.io" className="text-teal-600 hover:text-teal-700 font-medium">
              dev@verifyafrica.io
            </a>
          </p>
        </div>

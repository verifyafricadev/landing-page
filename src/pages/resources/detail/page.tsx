...
export default function ResourceDetailPage() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h1 className="text-xl font-bold text-gray-900 mb-2">Resource Not Found</h1>
          <p className="text-gray-500 mb-6">This resource does not exist or has been moved.</p>
          <button
  ...
  const handleUnlock = (resourceId: string, email: string) => {
    ...
    const stored = JSON.parse(localStorage.getItem('verifyafrica_unlocked') || '[]');
  ...
  const schema = [
    {
      ...
      dateModified: resource.dateAdded || new Date().toISOString().split('T')[0],
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="px-4 py-2 bg-gray-900 text-white text-sm font-medium rounded-lg hover:bg-gray-800 transition-all cursor-pointer flex items-center gap-2"
            >
              ...
              {isUnlocked ? (
                isPdfResource ? (
                  <div className="bg-emerald-50 rounded-xl border border-emerald-100 p-6 md:p-8">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        <h3 className="text-lg font-bold text-gray-900">PDF Unlocked</h3>
                        <p className="text-sm text-gray-500">Your download is ready</p>
                      </div>
                    </div>
                    <p className="text-gray-600 mb-6 leading-relaxed">
                      You now have full access to the complete PDF. Click below to download or view the document.
                    </p>
                    <button
                  ...
                  <div className="bg-emerald-50 rounded-xl border border-emerald-100 p-6 md:p-8">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        <h3 className="text-lg font-bold text-gray-900">Full Content Unlocked</h3>
                        <p className="text-sm text-gray-500">All actionable items are now visible</p>
                      </div>
                    </div>
                    <ul className="space-y-3">
                ...
                <div className="bg-gradient-to-br from-teal-50 to-emerald-50 rounded-xl border border-teal-100 p-6 md:p-8">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-gray-900">
                        {isPdfResource ? 'PDF Download Locked' : 'Full Content Locked'}
                      </h3>
                      <p className="text-sm text-gray-500">Enter your company email to unlock</p>
                    </div>
                  </div>
                  <p className="text-gray-600 mb-6 leading-relaxed">
                    {isPdfResource
                  ...
                  >
                    ...
                    {isPdfResource ? 'Unlock PDF Download' : 'Unlock Full Resource'}
                  </button>
            ...
            <div className="hidden lg:block">
              <div className="sticky top-28 space-y-6">
                ...
                <div className="bg-white rounded-xl border border-gray-100 p-6">
                  <h3 className="text-sm font-bold text-gray-900 mb-4">More Resources</h3>
                  <ul className="space-y-3">
                    {resources
                        ...
                        <li key={r.id}>
                          ...
                          >
                            <div className="w-8 h-8 bg-teal-50 rounded-lg flex items-center justify-center flex-shrink-0">
                              <i className={`${r.icon} text-teal-600 text-sm`} />
                            </div>
                            <div>
                ...
                <div className="bg-teal-50 rounded-xl p-6">
                  ...
                  <h3 className="text-sm font-bold text-gray-900 mb-2">Need Help Implementing?</h3>
                  <p className="text-xs text-gray-500 mb-4 leading-relaxed">
                    Our compliance team can help you put these frameworks into practice across your target markets.
                  </p>
                  <button
                    onClick={openDemo}

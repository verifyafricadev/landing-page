...
const FREE_EMAIL_DOMAINS = [
  ...
  'foxmail.com', 'gmx.com', 'gmx.net', 'hey.com', 'me.com',
  'mac.com', 'pm.me', 'tutanota.com', 'fastmail.com',
];
...
export default function EmailGateModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('https://readdy.ai/api/form/d7phe8vhqnrhtnv4fihg', {
        method: 'POST',
      ...
      if (response.ok) {
        ...
        const unlocked = JSON.parse(localStorage.getItem('verifyafrica_unlocked') || '[]');
        if (!unlocked.includes(resourceId)) {
          unlocked.push(resourceId);
          localStorage.setItem('verifyafrica_unlocked', JSON.stringify(unlocked));
        }
      } else {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-teal-500 to-emerald-500 px-6 py-5">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-white font-semibold text-sm">Unlock Full Resource</h3>
                <p className="text-white/80 text-xs truncate max-w-[200px]">{resourceTitle}</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="px-6 py-6">
          {!isSuccess ? (
            <form onSubmit={handleSubmit} data-readdy-form id={`lead-form-${resourceId}`}>
              <p className="text-gray-600 text-sm mb-5 leading-relaxed">
                Enter your company email to unlock the complete actionable checklist,
                framework, and step-by-step implementation guide.
              </p>
            ...
            <div className="text-center py-4">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Resource Unlocked!</h4>
              <p className="text-sm text-gray-600 mb-6">
                You now have full access to the complete guide. Scroll down to view the actionable content.
              </p>
              <button
                onClick={onClose}

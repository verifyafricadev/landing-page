...
export default function BlogSidebar() {
  ...
  const handleSubscribe = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const res = await fetch('https://readdy.ai/api/form/d7phe8vhqnrhtnv4fii0', {
        method: 'POST',
  ...
  return (
    <aside className="space-y-8">
      ...
      >
        ...
        <h3 className="text-base font-bold text-gray-900 mb-2">Stay Updated</h3>
        <p className="text-sm text-gray-500 mb-4 leading-relaxed">
          Get the latest compliance insights and regulatory updates delivered to your inbox weekly.
        </p>
      ...
      >
        <h3 className="text-base font-bold text-gray-900 mb-4">Popular Resources</h3>

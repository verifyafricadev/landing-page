		...
		<section className="pt-28 pb-16 bg-gradient-to-b from-teal-50/60 to-white">
			<div className="max-w-7xl mx-auto px-6 lg:px-12">
				...
				>
					...
					<h1 className="text-4xl lg:text-5xl font-bold text-secondary leading-tight mb-4">
						Compliance Insights <br className="hidden lg:block" />
						<span className="text-teal-600">&amp; Resources</span>
					</h1>
					<p className="text-lg text-gray-500 max-w-2xl">
						Expert analysis, regulatory updates, and practical guides to help
						you navigate Africa&apos;s compliance landscape with confidence.
					</p>
				</div>
						...
						>
							<div className="grid lg:grid-cols-2">
								...
								<div className="p-8 lg:p-10 flex flex-col justify-center">
									...
									<h2 className="text-2xl lg:text-3xl font-bold text-secondary mb-4 group-hover:text-teal-700 transition-colors leading-snug">
										{featured.title}
									</h2>

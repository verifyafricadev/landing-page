...
const dataDisposalSchema = [
  {
    ...
    description: 'VerifyAfrica Data Disposal & Destruction Policy outlining how personal and business data is securely retained, archived, and permanently destroyed.',
    publisher: {
      '@type': 'Organization',
      name: 'VerifyAfrica',
      url: SITE_URL,
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Data Disposal & Destruction Policy</h1>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Purpose of This Policy</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4 mb-4">
            <li>Personal and business data are not kept longer than necessary.</li>
            <li>Data disposal is carried out securely, verifiably, and in compliance with applicable laws.</li>
            <li>Individuals and organizations retain meaningful control over their data, including the right to request erasure.</li>
            <li>VerifyAfrica maintains transparency and accountability in all data-handling activities.</li>
          </ul>
          <p className="text-gray-600 leading-relaxed">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Legal and Regulatory Alignment</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-3 ml-4 mb-4">
            <li>
              <strong>Under GDPR (EU),</strong> we comply with Article 5(1)(e), which mandates that personal data be kept "no longer than is necessary for the purposes for which the personal data are processed." We also respect Article 17 (Right to Erasure) and Article 30 (Record of Processing Activities).
            </li>
            <li>
              <strong>Under NDPR (Nigeria),</strong> we adhere to Principle 2.1(5), which requires that personal data be retained only as long as necessary to achieve the purpose of processing or as required by law.
            </li>
            <li>
              <strong>Under Delaware and U.S. law,</strong> we apply the Federal Trade Commission's (FTC) data-disposal guidelines and relevant sectoral privacy rules governing the protection and destruction of consumer and corporate information.
            </li>
          </ul>
          <p className="text-gray-600 leading-relaxed">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Data Retention Principles</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Data Minimization and Archiving</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Methods of Data Destruction</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-3 ml-4">
            <li>
              <strong>Digital Data:</strong> Deleted using secure overwriting and cryptographic erasure methods that comply with NIST SP 800-88 (Rev.1) standards. Files, logs, and backups are securely wiped from servers and cloud systems using multi-pass algorithms, ensuring no residual data remains.
            </li>
            <li>
              <strong>Encrypted Data:</strong> When data is encrypted, destruction is achieved by destroying encryption keys, a process known as crypto-shredding, which instantly renders all associated data unreadable.
            </li>
            <li>
              <strong>Physical Media:</strong> Any drives, servers, or physical media that stored personal or verification data are decommissioned through certified destruction providers who issue a Certificate of Destruction confirming compliance with international standards such as ISO/IEC 27040 and ISO 21964.
            </li>
            <li>
              <strong>Third-Party Systems:</strong> Vendors and subprocessors are contractually required to destroy or return all VerifyAfrica data upon termination of engagement. Verification of destruction or return is obtained through written confirmation or audit reporting.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Data Disposal Requests and Right to Erasure</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4 mb-4">
            <li>Authenticate the requester's identity to ensure lawful access;</li>
            <li>Identify all relevant data across production, backups, and archives;</li>
            <li>Delete or anonymize the data within 30 days unless a legal obligation requires retention (for example, AML laws or contractual obligations to financial institutions); and</li>
            <li>Confirm completion of the deletion request to the requester in writing.</li>
          </ul>
          <p className="text-gray-600 leading-relaxed">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Backups and Redundancy Controls</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Audit Trails and Verification of Destruction</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4 mb-4">
            ...
            <li>Verification of completion (hash confirmation or destruction certificate).</li>
          </ul>
          <p className="text-gray-600 leading-relaxed">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Exceptions and Legal Holds</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Group Oversight and Governance</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            📩 support@verifyafrica.io<br />
            VerifyAfrica Inc., State of Delaware, United States<br />
            <br />
          </p>
          <p className="text-gray-600 leading-relaxed">
            If you believe that we have not properly honored a data deletion or disposal request, you also have the right to contact your local data protection authority, such as the Office of the Delaware Attorney General, or the Nigeria Data Protection Bureau (NDPB).
          </p>
        </section>
      </main>
    </div>

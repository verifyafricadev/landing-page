...
const termsSchema = [
  {
    ...
    url: `${SITE_URL}/terms`,
    description: 'VerifyAfrica Terms of Service governing the use of our KYC, AML, and identity verification platform.',
    publisher: {
      '@type': 'Organization',
      name: 'VerifyAfrica',
      url: SITE_URL,
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">1. Introduction and Contractual Nature</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
            These Terms of Use form the legally binding agreement between VerifyAfrica Inc. ("VerifyAfrica," "the Company," "we," or "us") — a Delaware-incorporated and any individual or organization ("Client," "User," or "Partner") that accesses, integrates, or utilizes the VerifyAfrica platform, APIs, SDKs, or any related services.
          </p>
          <p className="text-gray-600 leading-relaxed mb-4">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">2. Relationship Between VerifyAfrica and the Client</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">3. Authorized Use of Services</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">4. Client Responsibilities</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">5. VerifyAfrica's Obligations</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">6. Service Availability and Continuity</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">10. Suspension and Termination</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">11. Jurisdiction and Governing Law</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
        ...
        {/* 12. Amendments */}
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">12. Amendments</h2>
          <p className="text-gray-600 leading-relaxed">

...
export default function CoreValues() {
  ...
  return (
    <section id="values" ref={ref} className="py-24 bg-gray-50/60">
      <div className="max-w-6xl mx-auto px-6 lg:px-12">
        <div className="text-center mb-16">
          ...
          >
            Our values shape every product decision, every client interaction, and every line of code we write.
          </p>
        </div>
          ...
          {values.map((value, index) => (
            ...
            >
              ...
              <h4 className="text-lg font-bold text-gray-900 mb-2">
                <a href="#values" className="hover:text-teal-600 transition-colors">
                  {value.title}
                </a>
              </h4>

...
export default function HomeNavbar({ onRequestDemo }: NavbarProps) {
  ...
  const handleHashClick = (e: React.MouseEvent<HTMLAnchorElement>, href: string) => {
    e.preventDefault();
    smoothScrollTo(href, { duration: 1200, easing: 'easeInOutQuart', offset: -80 });
  };

  const handleMobileItemClick = (href: string, isLink?: boolean, isExternal?: boolean) => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
          <div className="relative flex items-center justify-between h-16 sm:h-20 lg:h-28 overflow-hidden lg:overflow-visible">
            ...
            <div className="flex lg:hidden items-center gap-2">
              ...
              >
                <i className={`${isMobileMenuOpen ? 'ri-close-line' : 'ri-menu-line'} text-xl sm:text-2xl`} />
              </button>
            </div>
          </div>
        </div>
      ...
      >
        <div className="px-6 py-8 space-y-2">
          ...
          <div className="pt-6 mt-4 border-t border-gray-200 space-y-4">
            ...
            <button
              onClick={() => { setIsMobileMenuOpen(false); onRequestDemo(); }}

    ...
    <section ref={ref} className="py-16 sm:py-20 lg:py-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 sm:gap-6 lg:gap-8">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6">The Problem</h2>
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-gray-900">The VerifyAfrica Solution</h2>

...
export default function Security() {
  ...
  return (
    <section ref={ref} className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-gray-900 to-gray-800 text-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-10 lg:gap-12 items-center">
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-3 sm:mb-6">Security & Compliance</h2>
            ...
            <div className="flex flex-wrap gap-1.5 sm:gap-3">
              {features.map((feature, index) => (
                ...
                >
                  {feature}
                  {index < features.length - 1 && <span className="ml-2 sm:ml-3 text-gray-600">•</span>}
                </span>
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2.5 sm:gap-4 lg:gap-6">
            {compliance.map((item, index) => (
              ...
              >
                ...
                <h3 className="text-xs sm:text-base lg:text-lg font-bold mb-0 sm:mb-1">{item.name}</h3>

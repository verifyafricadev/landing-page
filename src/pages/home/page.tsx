...
function SectionSkeleton() {
  return <div className="py-16 bg-white" aria-hidden="true" style={{ containIntrinsicSize: '0 400px' }} />;
}

/** Wrapper that defers rendering cost for off-screen sections */
function LazySection({ children, height = 600 }: { children: ReactNode; height?: number }) {
  return (
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <Suspense fallback={<SectionSkeleton />}>
        <LazySection height={500}><ProblemSolution /></LazySection>
      </Suspense>
      <Suspense fallback={<SectionSkeleton />}>
        <LazySection height={700}><Features /></LazySection>
      </Suspense>
      <Suspense fallback={<SectionSkeleton />}>
        <LazySection height={480}><ComplianceSystem /></LazySection>
      </Suspense>
      <Suspense fallback={<SectionSkeleton />}>
        <LazySection height={520}><HowItWorks /></LazySection>
      </Suspense>
      <Suspense fallback={<SectionSkeleton />}>
        <LazySection height={600}><UseCases /></LazySection>
      </Suspense>
      <Suspense fallback={<SectionSkeleton />}>
        <LazySection height={700}><Pricing /></LazySection>
      </Suspense>
      <Suspense fallback={<SectionSkeleton />}>
        <LazySection height={400}><Security /></LazySection>
      </Suspense>
      <Suspense fallback={<SectionSkeleton />}>
        <LazySection height={600}><FAQ /></LazySection>
      </Suspense>
      <Suspense fallback={<SectionSkeleton />}>
        <LazySection height={350}><FinalCTA onRequestDemo={openDemo} /></LazySection>
      </Suspense>
      <Suspense fallback={<SectionSkeleton />}>
        <Footer />
      </Suspense>
